...
},{"./Functions":"4Blfm","./Dom":"5Nh5r","./TimeBar":"6E1HU"}],"4Blfm":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
_parcelHelpers.export(exports, "randomInteger", function () {
  return randomInteger;
});
_parcelHelpers.export(exports, "randomIntegerNoDifficulty", function () {
  return randomIntegerNoDifficulty;
});
_parcelHelpers.export(exports, "threeDigitInt", function () {
  return threeDigitInt;
});
_parcelHelpers.export(exports, "variables", function () {
  return variables;
});
_parcelHelpers.export(exports, "pickQuestion", function () {
  return pickQuestion;
});
_parcelHelpers.export(exports, "addition", function () {
  return addition;
});
_parcelHelpers.export(exports, "subtraction", function () {
  return subtraction;
});
_parcelHelpers.export(exports, "multiplication", function () {
  return multiplication;
});
_parcelHelpers.export(exports, "division", function () {
  return division;
});
var _Dom = require("./Dom");
// (min,max) is both inclusive
function randomInteger(min, max) {
  return Math.floor((Math.random() * (max - min + 1) + min) * 2 ** (0.125 * (variables.questionCounter - 1)));
}
...
function replaceHTML() {
  _Dom.DOMSelectors.questionNumber.innerHTML = `${variables.questionCounter}`;
  _Dom.DOMSelectors.num1.innerHTML = `${variables.num1}`;
  _Dom.DOMSelectors.op.innerHTML = `${variables.op}`;
  _Dom.DOMSelectors.num2.innerHTML = `${variables.num2}`;
  _Dom.DOMSelectors.form.addEventListener("input", function () {
    if (_Dom.DOMSelectors.form.value == variables.ans) {
      _Dom.DOMSelectors.form.value = "";
...
},{"./Dom":"5Nh5r","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"5Nh5r":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
},{}],"6E1HU":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
},{"./Dom":"5Nh5r","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}]},["21c8X","3L8AI"], "3L8AI", "parcelRequire0698")
